               ...
               <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input 
                          type="text" 
                          placeholder="Search..."
                          className="h-[42px] pl-10 pr-4 bg-white border border-[#E5E7EB] rounded-xl text-[14px] text-[#BCC2C2] placeholder-[#9CA3AF] focus:border-[#1E6F73] focus:ring-1 focus:ring-[#1E6F73] transition-colors w-[220px] focus:outline-none font-normal"
                        />
                    </div>
           ...
           <div className="flex gap-4 mb-6">
              ...
              <div className="ml-auto mt-auto">
                 <input 
                   ...
                   className="h-[42px] px-4 w-[280px] bg-white border border-[#E5E7EB] rounded-xl text-[13px] text-[#BCC2C2] placeholder-[#9CA3AF] focus:border-[#1E6F73] focus:ring-1 focus:ring-[#1E6F73] transition-colors focus:outline-none font-normal"
                 />
              </div>
           </div>
