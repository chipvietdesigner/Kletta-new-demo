             ...
             {isPersonalDetailsEditing ? (
               <div className="flex gap-2">
                 <button 
                   ...
                   className="h-[36px] px-4 bg-white border border-[#E5E7EB] hover:bg-[#F9FAFB] text-[13px] text-[#0F2F33] font-medium rounded-xl transition-colors"
                 >
                   Cancel
                 </button>
                 <button 
               ...
               <button 
                 ...
                 className="h-[36px] px-4 bg-white border border-[#E5E7EB] hover:bg-[#F9FAFB] text-[13px] text-[#0F2F33] font-medium rounded-xl transition-colors shadow-sm"
               >
                 Update
               </button>
             )}
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-xl shadow-sm overflow-hidden">
                   ...
                   <button
                     ...
                     className={`h-[42px] px-5 rounded-xl text-[13px] font-medium transition-colors shadow-sm border ${
                       messageLanguage === lang
                         ...
                         : 'bg-white border-[#E5E7EB] text-[#0F2F33] hover:bg-[#F9FAFB]'
                     }`}
                   >
                     {lang}
                   </button>
          ...
          <div className="divide-y divide-[#E5E7EB]">
            {AUTO_MESSAGES_DATA.map((msg) => (
              <div key={msg.id} className="group px-8 py-5 min-h-[80px] flex items-center hover:bg-[#F9FAFB]/50 transition-colors">
                  ...
                  <div className="w-full flex items-center gap-4">
                     ...
                     <div className="flex items-center gap-2">
                       <button 
                         ...
                         className="h-[42px] px-4 bg-white border border-[#E5E7EB] hover:bg-[#F9FAFB] text-[13px] text-[#0F2F33] font-medium rounded-xl transition-colors"
                       >
                         Cancel
                       </button>
                       <button 
                  ...
                  <div className="w-full flex items-center justify-between">
                    ...
                    <div className="flex-shrink-0">
                       <button 
                         ...
                         className="h-[36px] px-4 bg-white border border-[#E5E7EB] hover:bg-[#F9FAFB] hover:border-[#D1D5DB] rounded-xl text-[12px] text-[#0F2F33] font-medium shadow-sm transition-all flex items-center gap-2"
