    ...
    <div className="flex min-h-screen w-full font-sans bg-white">
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-12 lg:px-20 xl:px-24 relative z-10">
        ...
        <div className="w-full max-w-[400px] mx-auto">
          <div className="mb-10"><h1 className="text-[24px] font-medium text-[#000000] mb-3 tracking-tight">Welcome back</h1><p className="text-[#000000] text-[14px] font-normal">Enter your details to access your accounting dashboard.</p></div>
