    ...
    <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#FCFCFC]">
      <div className="max-w-[880px] mx-auto px-6 py-10 pb-20">
        ...
        <div className="bg-white border border-[#E5E7EB] rounded-xl shadow-sm p-8 md:p-12 space-y-12">
          ...
          <div>
            <div className="flex items-center justify-between mb-6 pb-2 border-b border-[#F9FAFB]"><h2 className="text-[16px] font-medium text-[#000000]">Business Expenses</h2><Info size={16} className="text-[#D1D5DB]" /></div>
            <div className="space-y-1 pl-1">
