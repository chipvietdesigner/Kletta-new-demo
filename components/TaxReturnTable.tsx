        ...
        <table className="min-w-[1400px] text-left table-fixed w-full border-collapse">
          ...
          <thead className="bg-[#F9FAFB] text-[#4B5563] sticky top-0 z-10 h-[48px] border-b border-[#E5E7EB]">
            <tr>
              ...
              <th className="px-4 font-semibold text-[13px] w-[120px] text-center">Send status</th>
              ...
              <th className="px-4 font-semibold text-[13px] w-[120px]">Plan</th>
              <th className="px-4 font-semibold text-[13px] w-[100px]">Status</th>
              ...
              >
                ...
                <td className="p-0">
                   <div className="h-full flex items-center px-4">
                      <span className={`px-3 py-1 rounded-lg text-[12px] font-bold border ${getPlanStyle(row.plan)}`}>
                        {row.plan}
                      </span>
                   </div>
                </td>
                <td className="p-0">
                   <div className="h-full flex items-center px-4 text-[13px] text-[#0F2F33] font-bold">
                     {row.status}
                   </div>
                </td>
                <td className="p-0">
                   <div className="h-full flex items-center px-4 text-[#4B5563] tabular-nums text-[13px] font-medium">
                     ...
                     {row.isUtrVerified ? (
                       <SealCheck size={16} weight="fill" className="text-[#1E6F73]" />
                     ) : (
                       <div className="w-4 h-4 rounded-full border border-[#FCD34D] bg-[#FEF3C7] flex items-center justify-center">
                         <span className="text-[10px] text-[#92400E] font-bold">!</span>
                       </div>
                     )}
                   </div>
                </td>
